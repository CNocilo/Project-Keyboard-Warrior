  ...
  return (
    ...
    <h1 style={{ margin: '0', padding: '20px', fontSize: '2.5em' }}>Keyboard Warrior Leaderboard</h1>
      <div style={{ overflowX: 'auto' }}>
        <table className="table table-bordered table-border-black text-black" style={{ width: '80%', margin: '0 auto', borderCollapse: 'collapse', fontFamily: 'monospace', backgroundColor: '#fef9c3', border: '3px solid', animation: 'borderAnimation 5s infinite alternate' }}>
          <thead>
            <tr>
